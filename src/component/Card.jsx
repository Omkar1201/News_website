...
export default function Card({ single_data }) {
    ...
    return (
        <div className=' overflow-auto w-[18rem] border-2 rounded-md relative pb-5 hover:shadow-xl transition-all duration-[0.5s]'>
            <div className='min-w-full'><img alt='' className=' rounded-t-md min-w-full max-h-[12rem]' src={single_data.image} />
